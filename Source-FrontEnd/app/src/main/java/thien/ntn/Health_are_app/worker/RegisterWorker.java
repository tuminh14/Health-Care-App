...
public class RegisterWorker extends Worker {
    ...
    private static final String TAG = RegisterWorker.class.getSimpleName();
    private JSONObject requestBody;
    public RegisterWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) throws JSONException {
    ...
    public synchronized  Result doWork() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, Configs.API_URL.REGISTRY, this.requestBody,future,future);
