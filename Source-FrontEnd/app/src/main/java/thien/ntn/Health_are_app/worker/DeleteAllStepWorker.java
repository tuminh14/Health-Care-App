...
public class DeleteAllStepWorker extends Worker {

    private static final String TAG = DeleteAllStepWorker.class.getSimpleName();
    String token = "";
    public DeleteAllStepWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) throws JSONException {
    ...
    public synchronized  Result doWork() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.DELETE, Configs.API_URL.DELETE_ALL_STEP, null, future,future) {
            @Override
