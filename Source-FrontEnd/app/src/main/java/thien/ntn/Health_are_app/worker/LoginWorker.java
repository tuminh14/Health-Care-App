...
public class LoginWorker extends Worker {
    ...
    public LoginWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) throws JSONException {
    ...
    public synchronized  Result doWork() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, Configs.API_URL.LOGIN, this.requestBody,future,future);
